...
$id = $_GET["id"];
$queryk = query("SELECT * FROM kuisioner WHERE id = $id")[0]; 
...
body {
background: url(img/lemigas.png) no-repeat fixed;
		...
		<ul>	
			<input type ="hidden" name ="id" value="<?php echo $queryk["id"];?>">
				...
				<input type="text" class="input-field" name="nama" id="nama" 
				 value="<?= $queryk["bu"];  ?>" readonly> 

				<label for = "gambar" >  Select Your Photo  : </label> 
